...
def application(environ, start_response):
    ...
    def mostrar_error(tipo_error="general", campo=""):
        ...
        icono = "📱" if "telefono" in tipo_error else "🔢" if "codigo" in tipo_error else "⚠️"
    ...
    if path == '/' and method == 'GET':
        try:
            ...
            if conn:
                ...
                registros_html = '<p style="color: #dc3545;">Base de datos no disponible</p>'
        except:
            registros_html = '<p style="color: #dc3545;">Error cargando registros</p>'
