    ...
    if path == "/usuarios":
        ...
        try:
            ...
            for u in usrs:
                ...
                # Blindaje contra campos faltantes
            ...
            content = f"""<div class='card'><div style='display:flex; justify-content:space-between; align-items:center;'><h2>Gestión de Usuarios</h2><button class='btn-blue' onclick='document.getElementById("mU").style.display="block"'>+ Nuevo Usuario</button></div>
                ...
                </div><label style="margin-top:10px;">Fotografía de Perfil</label><input type="file" name="img"><button type="submit" class="btn-blue" style="width:100%; margin-top:20px;">Guardar Usuario</button>
            ...
            content = f"<div class='card'><h2>Error en Pantalla</h2><p style='color:#ef4444;'>{str(e)}</p></div>"
